define(["require", "exports", "esri/Map", "esri/views/MapView", "esri/config", "esri/geometry/SpatialReference", "esri/layers/support/TileInfo", "esri/layers/WebTileLayer", "esri/geometry/Extent", "dojo/dom", "dojo/on"], function (require, exports, Map, MapView, esriConfig, SpatialReference, TileInfo, WebTileLayer, Extent, dom, on) {
    "use strict";
